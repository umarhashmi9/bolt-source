...
const staticModels: ModelInfo[] = [
  ...
  { name: 'deepseek/deepseek-chat', label: 'inteligent (OpenRouter)', provider: 'OpenRouter' },
  ...
  { name: 'llama-3.1-405b-instruct', label: 'Smart Is Good Ai Agent (OpenRouter)', provider: 'OpenRouter' },
