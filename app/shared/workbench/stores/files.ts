...
import { bufferWatchEvents } from '~/shared/utils/buffer';
import { WORK_DIR } from '~/shared/utils/constants';
import { computeFileModifications } from '~/shared/utils/diff';
...
import {
  ...
  migrateLegacyLocks,
  clearCache,
} from '~/shared/lib/persistence/lockedFiles';
import { getCurrentChatId } from '~/shared/utils/fileLocks';
