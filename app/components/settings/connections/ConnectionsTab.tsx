...
export default function ConnectionsTab() {
  ...
  const handleSaveGithubConnection = () => {
  ...
  const handleSaveGitlabConnection = () => {
    Cookies.set('gitlabUsername', gitlabUsername);
    Cookies.set('gitlabToken', gitlabToken);
    logStore.logSystem('GitLab connection settings updated', {
      username: gitlabUsername,
      hasToken: !!gitlabToken,
    });
    toast.success('GitLab credentials saved successfully!');
  ...
  return (
    <div className="space-y-4">
      <div className="p-4 border border-bolt-elements-borderColor rounded-lg bg-bolt-elements-background-depth-3">
        ...
        <div className="flex">
          <button
            onClick={handleSaveGithubConnection}
      ...
      <div className="p-4 border border-bolt-elements-borderColor rounded-lg bg-bolt-elements-background-depth-3">
        <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-4">GitLab Connection</h3>
        <div className="flex mb-4">
          <div className="flex-1 mr-2">
            <label className="block text-sm text-bolt-elements-textSecondary mb-1">GitLab Username:</label>
            <input
              type="text"
        ...
        <div className="flex">
          <button
            onClick={handleSaveGitlabConnection}
            className="bg-bolt-elements-button-primary-background rounded-lg px-4 py-2 mr-2 transition-colors duration-200 hover:bg-bolt-elements-button-primary-backgroundHover text-bolt-elements-button-primary-text"
          >
