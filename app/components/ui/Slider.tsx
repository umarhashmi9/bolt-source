...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-white border-2 border-blue-200 overflow-hidden rounded-full p-1">
  ...
  return (
    <button
      ...
      className={classNames(
        'text-sm px-2.5 py-0.5 rounded-full relative',
        selected ? 'text-white' : 'text-gray-800 hover:text-blue-600',
      )}
    >
