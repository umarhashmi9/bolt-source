...
export const FeatureCard: React.FC<FeatureCardProps> = ({ feature, onStatusChange, onDeleteBranch }) => {
                ...
                >
                  ...
                  <DropdownMenu.Item
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      e.preventDefault();
                      onStatusChange(feature.id, 'pending');
                    }}
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <DropdownMenu.Item
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      e.preventDefault();
                      onStatusChange(feature.id, 'in-progress');
                    }}
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
