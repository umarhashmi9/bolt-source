...
- ⬜ Voice prompting
- ⬜ Supabase Integration (for database, authentication etc)
- ⬜ "Selector" functionality to be able to select an "element" via point and click in the preview for precise changes/edits.
